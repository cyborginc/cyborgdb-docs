...
<Tip>For more info on metadata, see [Metadata Filtering](/guides/data-operations/metadata-filtering).
Note that metadata filtering will not be available until `v0.9.0`</Tip>
