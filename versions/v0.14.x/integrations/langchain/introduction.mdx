...
description: "`v0.14.x`"
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/integrations/langchain/introduction
---
...
To install CyborgDB with LangChain support, you must install either `cyborgdb-core` with the `langchain` extra. You can do this using pip:
...
To use CyborgDB with LangChain, you can import the `CyborgVectorStore` class from the `cyborgdb_core.integrations.langchain` module.
