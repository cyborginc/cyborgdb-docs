...
### 🦜🔗 LangChain
The LangChain integration provides a `CyborgVectorStore` class that implements the standard VectorStore interface, enabling confidential vector search for RAG pipelines and LLM applications. This integration supports both `cyborgdb-core` and includes:
