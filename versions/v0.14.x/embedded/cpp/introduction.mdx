---
title: "CyborgDB Embedded - C++ API Reference"
sidebarTitle: "C++ API Introduction"
description: "`v0.14.x`"
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/embedded/cpp/introduction
---
...
This API is also exposed via PyBind11 in the [Python API](../python/introduction).
