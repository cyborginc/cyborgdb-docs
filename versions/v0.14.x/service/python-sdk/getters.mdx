---
title: "Getters"
canonical: https://docs.cyborg.co/versions/latest/service/python-sdk/getters
---
...
Returns the type of the index (for example, `'ivf'`, `'ivf_pq'`, or `'ivf_flat'`).
...
|----------|------|-------------|
| `type` | `str` | Index type (`'ivf'`, `'ivf_flat'`, or `'ivf_pq'`) |
