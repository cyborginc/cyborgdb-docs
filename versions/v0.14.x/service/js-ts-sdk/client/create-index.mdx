...
| `indexConfig` | [`IndexIVFPQ`](../types#indexivfpq) \| [`IndexIVFFlat`](../types#indexivfflat) \| [`IndexIVF`](../types#indexivf) | _(Optional)_ Configuration object specifying the index type (`ivf`, `ivfpq`, or `ivfflat`). Defaults to `{ type: 'ivfflat', dimension: undefined }`. |
