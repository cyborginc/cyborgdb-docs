...
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/service/guides/advanced/env-vars
---
...
<Note>
**Default Behavior:** If you don't set `CYBORGDB_DB_TYPE` or `CYBORGDB_CONNECTION_STRING`, the service automatically uses a built-in **standalone** instance for evaluation and testing. Data is stored in `~/.cyborgdb/standalone.db`.
