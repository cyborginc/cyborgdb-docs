...
canonical: https://docs.cyborg.co/versions/latest/service/guides/advanced/configure-index
---
...
func main() {
    ...
    // Create the IVF index config (specify dimension, e.g., 768)
    indexConfig := cyborgdb.IndexIVF(768)
