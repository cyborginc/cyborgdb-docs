...
<Steps>
    ...
    <Step title="Choose Your Database Backend (Optional)">
        For **quick evaluation and testing**, you can skip database setup entirely - the service will automatically use a built-in **standalone** instance (backed by redis-lite).
        ...
        <Warning>**Standalone is for evaluation and testing only** - For production use, configure an external PostgreSQL or Redis database.</Warning>
    </Step>
    ...
    <Step title="Configure Environment Variables">
        ...
        <Tabs>
            <Tab title="Quick Start (Standalone)">
                ...
                <Warning>Standalone is for evaluation and testing only. For production, use PostgreSQL or Redis.</Warning>
            </Tab>
    ...
    <Step title="Advanced Configuration">
        ...
        <Tabs>
            <Tab title="Environment Variables">
                ...
                <Note>If `CYBORGDB_DB_TYPE` and `CYBORGDB_CONNECTION_STRING` are not set, the service uses a built-in standalone database (backed by redis-lite) for evaluation. For production, configure an external database. For more information, refer to [this guide](../advanced/env-vars).</Note>
