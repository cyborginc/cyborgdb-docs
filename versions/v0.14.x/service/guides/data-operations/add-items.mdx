...
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/service/guides/data-operations/add-items
---
...
import { VectorItem, UpsertParams } from 'cyborgdb';
...
// Add items to the encrypted index
const params: UpsertParams = { items };
...
```typescript TypeScript SDK icon="code"
import { VectorItem, UpsertParams, EncryptedIndex, CreateIndexParams } from 'cyborgdb';

// ... index creation and embedding model setup
const embeddingModel: string = "sentence-transformers/all-MiniLM-L6-v2";
const indexParams: CreateIndexParams = {
    indexName: "my_index", 
    indexKey, 
    indexConfig, 
    embeddingModel 
