...
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/embedded/guides/data-operations/query
---
...
// Perform query
cyborg::QueryParams query_params(top_k, n_probes, filters, include, greedy);
cyborg::QueryResults results = index->Query(query_vectors, query_params);
