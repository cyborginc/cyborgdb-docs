...
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/embedded/guides/data-operations/metadata-filtering
---

CyborgDB supports metadata tagging and filtering, enabling fine-grained search filters in addition to encrypted vector search. Metadata, like vectors, is encrypted at rest and during index traversal.
