...
title: "List Indexes"
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/embedded/python/client/list-indexes
---
...
items_location = cyborgdb.DBConfig(location='redis', connection_string="redis://localhost")
