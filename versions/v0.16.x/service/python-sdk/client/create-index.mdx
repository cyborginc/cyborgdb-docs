...
title: "Create Index"
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/service/python-sdk/client/create-index
---
...
| `index_config` | `IndexIVFFlat \| IndexIVFPQ \| IndexIVFSQ` | `None` | _(Optional)_ Index configuration object |
