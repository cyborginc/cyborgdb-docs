...
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/service/guides/data-operations/metadata-filtering
---

CyborgDB supports metadata tagging and filtering, enabling fine-grained search filters in addition to encrypted vector search. Metadata, like vectors, is encrypted in use. The backing store holds only ciphertext.
