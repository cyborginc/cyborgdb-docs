...
title: "Create Index"
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/service/js-ts-sdk/client/create-index
---
...
| `indexConfig` | [`IndexIVFPQ`](../types#indexivfpq) \| [`IndexIVFFlat`](../types#indexivfflat) \| [`IndexIVFSQ`](../types#indexivfsq) | _(Optional)_ Configuration object specifying the index type (`ivfflat`, `ivfpq`, or `ivfsq`). Defaults to `{ type: 'ivfflat', dimension: undefined }`. |
