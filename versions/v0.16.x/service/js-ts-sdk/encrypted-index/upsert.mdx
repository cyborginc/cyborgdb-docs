...
title: "Upsert"
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/service/js-ts-sdk/encrypted-index/upsert
---
...
| `metadata` | `(Record<string, unknown> \| null)[]` | _(Optional)_ Array of metadata objects corresponding to each ID |
| `contents` | `(string \| null)[]` | _(Optional)_ Array of content strings corresponding to each ID |
