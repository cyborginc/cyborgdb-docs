...
<Update label="v0.14.0" description="2025-01-XX">
...
- Introduced **Standalone** database mode for quick evaluation and testing:
    ...
    - Backed by redis-lite for zero-configuration setup
    - Perfect for rapid prototyping and development without infrastructure overhead
    - Not recommended for production use - use PostgreSQL or Redis for production deployments
- Enhanced TypeScript SDK with improved type definitions:
    - Added comprehensive type exports for better IDE support and type safety
    - Improved type inference for API methods
- Updated documentation with new Standalone backing store option

### Improvements

- Simplified quickstart experience with automatic database provisioning
- Enhanced documentation clarity around backing store options
- Improved environment variable configuration with sensible defaults
