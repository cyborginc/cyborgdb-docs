...
<Update label="v0.11.0" description="2025-07-XX">
...
- REST API (Microservice via Python or Docker - *GA*)
- Client SDK (Python, JavaScript & TypeScript - *GA*)
...
- CyborgDB Client SDKs now available for REST API microservice
    ...
    - JavaScript
    - TypeScript
- Added LangChain integrations for JS
- Introduced API key management and Admin Dashboard
- Optimized concurrency with opportunistic mutexes
