...
<Update label="v0.11.0" description="2025-07-10" tags={["update"]}>
...
- CyborgDB Client SDKs now available for REST API microservice
    ...
    - JavaScript
    - TypeScript
- Added integration with LangChain for JavaScript, enabling seamless orchestration in client applications
...
<Update label="v0.10.0" description="2025-04-30" tags={["update"]}>
...
- Added configurable logging utility for core library in [C++](/versions/v0.10.x/api-reference/cpp/client/logger) and [Python](/versions/v0.10.x/api-reference/python/client/logger)

</Update>

<Update label="v0.9.2" description="2025-04-14" tags={["patch"]}>
...
<Update label="v0.9.1" description="2025-03-28" tags={["patch"]}>
...
<Update label="v0.9.0" description="2025-02-28" tags={["update"]}>
...
<Update label="v0.8.0" description="2024-12-19" tags={["update"]}>
...
<Update label="v0.7.0" description="2024-10-31" tags={["update"]}>
