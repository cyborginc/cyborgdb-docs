...
<Steps>
    <Step title="Get an API Key">
        To use CyborgDB, you need an API key:

        ```python
        api_key = "your_api_key_here"  # Replace with your CyborgDB API key
        ```

        Get an API key from the [CyborgDB Admin Dashboard](https://cyborgdb.co). For more info, follow [this guide](../../../intro/get-api-key).
