...
<CardGroup cols={1}>
  <Card title="Embedded Quickstart" href="/versions/v0.17.x/embedded/guides/intro/quickstart" icon="rocket">
...
flowchart TB
  ...
  Library --> Disk("Disk (local, RocksDB-backed)")
  Library --> S3("S3 (AWS or S3-compatible)")
...
<CardGroup cols={3}>
  <Card title="Start Building" href="/versions/v0.17.x/embedded/guides/intro/quickstart" icon="rocket">
...
Ready to build confidential AI applications with complete control? Start with our [Embedded Quickstart](/versions/v0.17.x/embedded/guides/intro/quickstart) guide!