...
| `index_config` | [`IndexConfig`](../types#indexconfig) | _(Optional)_ Configuration specifying the index type and parameters. When not provided, uses `IndexIVFSQ(sq_bits=16)` defaults. |
...
items_location = cyborgdb.DBConfig(location='rocksdb')
