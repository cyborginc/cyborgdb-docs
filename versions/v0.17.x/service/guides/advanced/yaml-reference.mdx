...
- [Multi-Tenancy & RBAC](./multi-tenancy) — the `cyborgdb_root_api_key` key and its operator implications.
...
service:
  ...
  cyborgdb_root_api_key: ${CYBORGDB_ROOT_API_KEY}  # string. Optional. When set, enables RBAC.
                                                   # See ./multi-tenancy.
...
- [Multi-Tenancy & RBAC](./multi-tenancy) — the `cyborgdb_root_api_key` operator playbook.
