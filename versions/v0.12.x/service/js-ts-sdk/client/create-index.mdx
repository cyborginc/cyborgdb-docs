...
| `indexConfig` | [`IndexIVFPQ`](../types#indexivfpq) \| [`IndexIVFFlat`](../types#indexivfflat) \| [`IndexIVF`](../types#indexivf) | Configuration object specifying the index type (`ivf`, `ivfpq`, or `ivfflat`). |
