...
No private data is ever collected or shared, and all telemetry data is encrypted before being sent to the server. Below you can find a comprehensive list of the telemetry events that are collected:
