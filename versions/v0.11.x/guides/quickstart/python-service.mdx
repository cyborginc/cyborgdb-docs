...
<Steps>
    ...
    <Step title="Choose Your Database Backend">
        CyborgDB service supports two database backends:
        
        - **PostgreSQL**: Recommended for production workloads, complex queries, and ACID compliance
        - **Redis**: Ideal for high-speed caching and simple key-value operations with ultra-fast read performance
