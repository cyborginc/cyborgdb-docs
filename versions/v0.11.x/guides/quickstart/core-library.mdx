---
title: "CyborgDB Core Library Quickstart"
...
<Tip>CyborgDB's core library is offered as two packages: `cyborgdb_core` and `cyborgdb_lite`. This guide shows how to get started with either. For more details on the difference between both packages, read more [here](./about#cyborgdb-lite).</Tip>
