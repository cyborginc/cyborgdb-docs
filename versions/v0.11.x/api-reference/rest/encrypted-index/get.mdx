...
| `ids` | `array[string]` | - | List of item IDs to retrieve |
| `include` | `array[string]` | `["vector", "contents", "metadata"]` | Fields to include in response |

## Include Fields

- `"vector"`: Original vector embeddings (IVFFlat indexes only)
- `"contents"`: Text content associated with the vector
