...
<Tip>For guidance on selecting the right index configuration and parameters, refer to the [index configuration tuning guide](/guides/tuning/index-config.md).</Tip>
