...
Retrieve the nearest neighbors for a given query vector. Passing `text` alongside `query_vectors` turns this into a **hybrid** query that fuses BM25 full-text ranking with the vector ranking (see [Full-text and hybrid search](../../../embedded/guides/data-operations/bm25-search)).
