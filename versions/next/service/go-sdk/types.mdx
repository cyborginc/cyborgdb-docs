...
type CreateIndexParams struct {
    ...
    StoragePrecision *string `json:"storage_precision,omitempty"` // "float32" | "float16" | "tq12" | "tq8" | "tq6" | "tq4"
}
```
