...
<Tabs>
    <Tab title="Embedded">
        ...
        |-------------------|----------------------------------|--------------|--------------------------------------------------------------------|
        | `location` | `string` | - | DB location (`disk`, `s3`, `memory`) |
        ...
        - `"disk"`: Use for persistent, on-disk key-value storage (recommended for embedded/local deployments).
        ...
        |-----------|------|---------|-------------|
        | `n_lists` | `int` | 1024 | Number of inverted lists (clusters) |
        | `sq_bits` | `int` | 16 | Bits per scalar quantized value |
