...
CyborgDB offers two deployment approaches, each optimized for different use cases and operational requirements. Both models are **self-hosted** and run entirely within your own infrastructure.
...
Deploy CyborgDB as a self-contained microservice that provides REST API access to confidential vector search. The service runs on your infrastructure and can scale independently from your applications.
