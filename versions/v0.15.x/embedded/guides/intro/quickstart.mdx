...
<Steps>
    <Step title="Get an API Key">
        ...
        For production use, get a full API key from the [CyborgDB Admin Dashboard](https://cyborgdb.co). For more info, follow [this guide](../../../intro/get-api-key).
    ...
    <Step title="Create a Client">
        ...
        cyborg::DBConfig items_location(cyborg::Location::kRocksDB);  // Where item contents are stored (for upsert/get)
