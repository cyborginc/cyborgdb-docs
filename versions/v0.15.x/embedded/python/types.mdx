...
| `query` | `bool` | `False` | _(Optional)_ Enable GPU for query operations |
...
gpu_config1 = cyborgdb.GPUConfig(upsert=True, train=True, query=True)
...
|--------------|-------------------------------|---------|-------------------------------------------------------------------------------|
| `dimension` | `int` | `0` | _(Optional)_ Dimensionality of vector embeddings. Auto-detected if 0. |
| `pq_dim` | `int` | `0` | _(Optional)_ Dimensionality of PQ codes after quantization. Auto-detected if 0. |
| `pq_bits` | `int` | `8` | _(Optional)_ Number of bits per quantizer (between 1 and 16). |
...
<Tip>If `dimension` or `pq_dim` is not provided (or set to 0), it will be auto-determined based on the first vector embedding added to the index.</Tip>
...
|--------------|-------------------------------|---------|-------------------------------------------------------------------------------|
| `dimension` | `int` | `0` | _(Optional)_ Dimensionality of vector embeddings. Auto-detected if 0. |
| `sq_bits` | `int` | `8` | _(Optional)_ Number of bits for scalar quantization (typically 4, 8, or 16). |
