...
| `n_probes` | `int` | `0` (auto) | _(Optional)_ Number of lists probed during the query; higher values may increase recall but can also reduce performance. When set to `0` or omitted, automatically determines the optimal value. |
