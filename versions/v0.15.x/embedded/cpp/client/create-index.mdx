...
title: "Create Index"
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/embedded/cpp/client/create-index
---
...
| `index_config` | [`IndexConfig`](../types#indexconfig) | _(Optional in overload 2)_ Configuration for the index type. When not provided, uses IndexIVFSQ (16-bit) defaults. |
