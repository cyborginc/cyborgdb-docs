---
title: "Types"
canonical: https://docs.cyborg.co/versions/latest/service/js-ts-sdk/types
---
...
|-----------|------|----------|-------------|
| `indexConfig` | [`IndexConfig`](#indexconfig) | No | Configuration model specifying index type and parameters. Defaults to `{ type: 'ivfflat' }` if not provided |
