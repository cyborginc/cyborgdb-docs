...
<Note>For IVFPQ and IVFSQ index types, the `vector` field cannot be included in the response as these index types use compression techniques that don't preserve original vectors.</Note>
