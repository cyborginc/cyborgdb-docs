...
title: "Upsert"
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/service/python-sdk/encrypted-index/upsert
---
...
| `metadata` | `List[Dict]` | `None` | _(Optional)_ List of metadata dictionaries, one per vector |
| `contents` | `List[str \| bytes]` | `None` | _(Optional)_ List of content values, one per vector. Bytes are base64-encoded, strings are passed directly. All contents are encrypted before storage |
