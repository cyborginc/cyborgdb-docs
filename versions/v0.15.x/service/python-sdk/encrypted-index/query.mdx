...
title: "Query"
mode: "wide"
canonical: https://docs.cyborg.co/versions/latest/service/python-sdk/encrypted-index/query
---
...
| `include` | `List[str]` | `None` | _(Optional)_ Fields to include in results. `None` includes all available fields. Note: `id` and `distance` are always included regardless of this parameter |
