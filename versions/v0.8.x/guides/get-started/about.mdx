---
title: "About Cyborg Vector Search"
---
...
<img src="/images/cyborg-vector-search-search-overview.png" alt="Cyborg Vector Search RAG Overview" />
...
In this form, Cyborg Vector Search is packaged as a standalone module (Python or C++) which contains all of the encrypted indexing and querying logic. The module is run locally and can connect to any of the supported [backing stores](#backing-stores).
