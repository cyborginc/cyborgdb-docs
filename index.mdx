...
<CardGroup cols={3}>
    <Card title="Learn the Fundamentals" href="versions/latest/intro/about" icon="book-open-cover">
        Understand the architecture and principles behind encrypted vector search
    </Card>
    <Card title="Start Building" href="versions/latest/intro/quickstart" icon="rocket-launch">
        Get hands-on with CyborgDB in minutes using our quickstart guide
    </Card>
    <Card title="Explore Deployment Options" href="versions/latest/intro/deployment-models" icon="server">
...
<CardGroup cols={3}>
    <Card title="Introduction" href="versions/latest/intro/about" icon="graduation-cap">
        Core concepts, deployment models, and getting started guides
    </Card>
    <Card title="CyborgDB Service" href="versions/latest/service/guides/intro/about" icon="cloud">
        CyborgDB self-hosted with REST API and client SDKs
    </Card>
    <Card title="CyborgDB Embedded" href="versions/latest/embedded/guides/intro/about" icon="code">
        Self-hosted, embedded deployments with Python and C++ bindings
    </Card>
</CardGroup>

<CardGroup cols={2}>
    <Card title="Integrations" href="versions/latest/integrations/about" icon="plug">
        LangChain and other framework integrations for seamless adoption
    </Card>
    <Card title="How to Use These Docs" href="versions/latest/intro/using-docs" icon="map">
